  ...
  <div class="admin-content">
      ...
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">安全评价师</strong><small></small></div>
    </div>
								        ...
								        <div class="am-popup-bd modelHei">
								          <form class="am-form am-padding-top am-padding-bottom" method="post" action="" enctype="multipart/form-data">
											<div class="am-g am-margin-top-sm">
												...
												<div class="am-u-sm-8 am-u-end">
													<input type="text" class="am-input-sm" value="三级" name="title" required>
												</div>
											</div>
											<div class="am-g am-margin-top-sm">
												<div class="am-u-sm-offset-2 am-u-sm-8 am-u-end">
								        ...
								        <div class="am-popup-bd modelHei">
								          <form class="am-form am-padding-top am-padding-bottom" method="post" action="" enctype="multipart/form-data">
											<div class="am-g am-margin-top-sm">
												...
												<div class="am-u-sm-8 am-u-end">
													<input type="text" class="am-input-sm" value="二级" name="title" required>
												</div>
											</div>
											<div class="am-g am-margin-top-sm">
												<div class="am-u-sm-offset-2 am-u-sm-8 am-u-end">
