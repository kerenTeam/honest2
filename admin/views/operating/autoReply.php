<div class="admin-content">
	...
	<ul class="am-nav am-nav-tabs am-margin-left am-margin-right">
		<li class="am-active"><a  href="<?=site_url('operating/autoReply');?>">关注后自动回复</a></li>
		<li><a href="<?=site_url('operating/autoReply1');?>">关键词自动回复</a></li>
		<li><a href="<?=site_url('operating/autoReply2');?>">智能自动回复</a></li>
	</ul>

	<div class="am-g am-padding-top-lg">
			...
			<div class="am-popup-bd">
				<form class="am-form am-padding-top am-padding-bottom" method="" action="">
					...
					<div class="am-g am-margin-top-sm">
						...
						<div class="am-u-sm-8 am-u-end">
							<input type="text" class="am-input-sm" disabled>
						</div>
					</div>
					<div class="am-g am-margin-top-sm">
						<div class="am-u-sm-3 am-text-right">
	...
	<!-- 问题解答列表 -->
	<div class="am-cf"></div>
	<p class="am-text-danger am-margin-left am-margin-top">*只能启用一条规则</p>
	<div class="am-g">
											...
											<div class="am-popup-bd">
												<form class="am-form am-padding-top am-padding-bottom" method="" action="">
													<div class="am-g am-margin-top-sm">
														...
														<div class="am-u-sm-8 am-u-end">
															<input type="text" class="am-input-sm" value="1" required>
														</div>
													</div>
													<div class="am-g am-margin-top-sm">
														<div class="am-u-sm-3 am-text-right">
														...
														<div class="am-u-sm-8 am-u-end">
															<input type="text" class="am-input-sm" value="nihao" disabled>
														</div>
													</div>
													<div class="am-g am-margin-top-sm">
														<div class="am-u-sm-3 am-text-right">
														...
														<div class="am-u-sm-8 am-u-end">
															<input type="url" class="am-input-sm" value="2" required>
														</div>
													</div>
													<div class="am-g am-margin-top-sm">
														<div class="am-u-sm-3 am-text-right">
														...
														<div class="am-u-sm-8 am-u-end">
															<textarea rows="4" required>12165465456</textarea>
														</div>
													</div>
													<div class="am-g am-margin-top-sm">
														<div class="am-u-sm-3 am-text-right">
