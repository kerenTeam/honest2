  ...
  <div class="admin-content">
      ...
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">安全查询</strong><small></small></div>
    </div>
		...
		<div class="am-g">
			<div class="am-u-sm-12">
				<table class="am-table am-table-striped am-table-hover am-main am-table-centered am-table-bordered">
					<thead>
						<tr>
							<th><input type="checkbox" class="allcheck"></th><th>ID</th><th class="table-type">用户名</th><th class="table-date am-hide-sm-only">查询内容</th><th class="table-date am-hide-sm-only">查询时间</th><th class="table-set">操作</th>
						</tr>
					</thead>
					<tbody id="movies">
						<tr>
